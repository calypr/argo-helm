...
*/}}
{{- define "calypr-projects.externalSecrets.enabled" -}}
...
*/}}
{{- define "calypr-projects.vault.enabled" -}}
...
*/}}
{{- define "calypr-projects.secretStore.kind" -}}
...
*/}}
{{- define "calypr-projects.secretStore.name" -}}
...
*/}}
{{- define "calypr-projects.secretStore.namespace" -}}
...
*/}}
{{- define "calypr-projects.vault.backend" -}}
...
*/}}
{{- define "calypr-projects.vault.auth" -}}
...
*/}}
{{- define "calypr-projects.repoRegistration.namespace" -}}
{{- $repoUrl := .repoUrl -}}
...
*/}}
{{- define "calypr-projects.repoRegistration.eventName" -}}
{{- $repoUrl := .repoUrl -}}
{{- $cleaned := trimSuffix ".git" $repoUrl -}}
{{- $cleaned = trimPrefix "https://" $cleaned -}}
{{- $cleaned = trimPrefix "http://" $cleaned -}}
...
*/}}
{{- define "calypr-projects.vault.extractKey" -}}
{{- $path := . -}}
{{- if contains "#" $path -}}
...
*/}}
{{- define "calypr-projects.vault.extractProperty" -}}
{{- $path := . -}}
{{- if contains "#" $path -}}
{{- $parts := splitList "#" $path -}}
{{- if gt (len $parts) 1 -}}
